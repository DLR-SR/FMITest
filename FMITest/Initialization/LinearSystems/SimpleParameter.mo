...
package SimpleParameter
  "Simple steady state initialization of an FMU leading to a linear system of equations over FMUs during initialization. A parameter is back-calculated from the state/steady-state conditions"
  extends Modelica.Icons.ExamplesPackage;

  model WithFMUsReference
    "Reference solution in pure Modelica using exactly the same structuring as in Model WithFMUs"
    extends Modelica.Icons.Example;
    FMUModels.SimpleLinearModel simpleWithParameter(
    ...
    equation
      ...
      annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{
            ...
            Text(
              ...
              textString="linear
with gain"),Text(
              extent={{-156,-108},{164,-140}},
              lineColor={0,0,0},
              textString="gain=%gain")}));
    end SimpleLinearModel;
